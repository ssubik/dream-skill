...
These are kit conventions, not Claude Code platform limits.
...
Use a new `.claude/memory/episodes/<UTC-timestamp>-<topic-slug>.md`. The timestamp is
...
Use episode paths relative to `.claude/memory/` and enough excerpt/context to audit the
