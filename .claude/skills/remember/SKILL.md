...
Append one dated line to the right topic file under `.claude/dreaming/topics/`.

1. Read `.claude/dreaming/MEMORY.md` and the topic the claim belongs to. If the claim is
